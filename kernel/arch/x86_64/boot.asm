...
gdt64:
    dq 0
.code: equ $ - gdt64
    dq (1<<40)|(1<<43)|(1<<44)|(1<<47)|(1<<53) | 0xFFFF | (0xF<<48) | (1<<55)                ; kernel code
.data: equ $ - gdt64
    dq (1<<40)|(1<<41)|(1<<44)|(1<<47)|(1<<54) | 0xFFFF | (0xF<<48) | (1<<55)               ; kernel data
.udata: equ $ - gdt64
    dq (1<<40)|(1<<41)|(1<<44)|(1<<47)|(3<<45)|(1<<54) | 0xFFFF | (0xF<<48) | (1<<55)       ; user data
.ucode: equ $ - gdt64
    dq (1<<40)|(1<<43)|(1<<44)|(1<<47)|(1<<53)|(3<<45) | 0xFFFF | (0xF<<48) | (1<<55)       ; user code
.tss: equ $ - gdt64
    dq 0
    dq 0
.pointer:
